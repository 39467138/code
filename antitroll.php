   ...
   <style>
    ...
    //                'Access-Control-Allow-Origin': '*',
         		...
         		success: function(response4) {
         				var $tweets4 = $('<p></p>');
         					var obj = JSON.parse(response4);
         					$tweets4.append('<p id="sent_p" >Positive: ' + ((obj.positive)*100).toFixed(0) + "%" + '</p><p id="sent_n" >Negative: ' + ((obj.negative)*100).toFixed(0) + "%" + '</p>');
         				$('.sent').html($tweets4);
      ...
      <header class="w3-container w3-blue w3-center w3-padding-128">
         ...
         <br><br>
         <input class="w3-border" id="username" type="text" placeholder="Search for trending keywords" style="width:300px; height:50px; border-radius:5px; padding:20px; color:#333333; background:#fff;"><br>
